...
namespace ec2 {
    namespace graphics {
        ...
        GLuint Shader::load()
        {
            ...
            std::string  vertSourceString = FileUtils::read_file(_vertPath).c_str();
            std::string fragSourceString = FileUtils::read_file(_fragPath).c_str();
            ...
            glGetShaderiv(vertex, GL_COMPILE_STATUS, &vertResult);
